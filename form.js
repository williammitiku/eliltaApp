      ...
      if (responseData.message) {
        ...
        if (locationCheck === 0) {
          try {
            ...
            if (responseData.message) {
              console.log("Shop location updated successfully:", responseData.message);
            } else {
              console.log("Shop location updated successfully!");
            }
          } catch (error) {
            console.error("Error updating shop location:", error.message);
